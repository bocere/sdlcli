...
Because I use Linux. And sometimes I just need to answer a small question ("Which version of
this topic is used in this publication?") and I don't want to fire up a Windows VM just to use 
SDL's desktop client. Plus it serves as the backend to web applications running on 
